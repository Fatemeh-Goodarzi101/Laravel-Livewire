<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- National Code -->
        <div class="col-span-3 sm:col-span-4">
            <x-jet-label for="national_code" value="{{ __('National Code') }}" />
            <x-jet-input id="national_code" type="text" class="mt-1 block w-full" wire:model.defer="state.national_code" autocomplete="national_code" />
            <x-jet-input-error for="national_code" class="mt-2" />
        </div>
