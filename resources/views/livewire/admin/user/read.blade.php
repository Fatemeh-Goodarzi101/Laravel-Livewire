            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style='cursor: pointer' wire:click="sort('national_code')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'national_code') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'national_code') fa-sort-amount-up ml-2 @endif'></i> {{ __('National_code') }} </td>
                        <td style='cursor: pointer' wire:click="sort('phone_number')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'phone_number') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'phone_number') fa-sort-amount-up ml-2 @endif'></i> {{ __('Phone_number') }} </td>
